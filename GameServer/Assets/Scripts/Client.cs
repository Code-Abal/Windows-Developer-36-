...
public class Client
{
    ...
    public class TCP
    {
        ...
        public void Connect(TcpClient _socket)
        {
            ...
            //주석ServerSend.Welcome(id, "Welcome to the server!");
        }
    ...
    //주석 public void SendIntoLobby(string _playerName)
    //{
    ...
    //            ServerSend.EnterLobby(id, _client.Player);
    //    }
    //    foreach(Client _client in Server.clients.Values)
    //    {
    //        if(_client.Player != null && _client.Player.id != id)
    //            ServerSend.EnterLobby(_client.id, Player);
    //    }
    //}
