        ...
        packetHandlers = new Dictionary<int, PacketHandler>()
            {
                ...
                //{ (int)ClientPackets.ReadyButton, ServerHandler.Ready },
                //{ (int)ClientPackets.GetItem, ServerHandler.GetItem },
                //{ (int)ClientPackets.ChangeHand, ServerHandler.ChangeHand },
                { (int)ClientPackets.NewUserinfo, ServerHandler.UserInfo},
                { (int)ClientPackets.UserLogininfo, ServerHandler.UserLoginInfo },
                { (int)ClientPackets.NewIDCheck, ServerHandler.NewIDCheck }
            };
